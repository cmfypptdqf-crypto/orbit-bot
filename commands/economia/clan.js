...
module.exports = {
    name: 'clan',
    aliases: ['guild', 'equipe', 'starfed', 'federacao'],
    ...
    async executePrefix(message, args, client) {
        ...
        const xpGanho = 5;
        const resultadoXP = adicionarXP(userId, xpGanho, 'clan');
        ...
        // ========== COMANDO: INFO ==========
            ...
            for (const id of clan.membros) {
                try {
                    ...
                    const userData = db.usuarios[id] || { carteira: 0, banco: 0 };
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { 
                        ...
                        value: `${barraProgresso} **${progresso}%**\n📊 XP: ${xpAtual.toLocaleString()} / ${xpNecessario.toLocaleString()}\n🎯 Faltam: **${(xpNecessario - xpAtual).toLocaleString()} XP** para o próximo nível!`, 
                        inline: false 
                    },
                    { name: '⭐ Stellar XP', value: `+${xpGanho} XP (consulta)`, inline: true }
                );
        ...
        // ========== COMANDO: CONVIDAR ==========
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`Convite orbital enviado para ${user}! Use \`bt!clan entrar\` para aceitar. (Expira em 5 minutos)`)
        ...
        // ========== COMANDO: ENTRAR ==========
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`Você entrou no clã **${clan.nome}**! Bem-vindo(a), comandante orbital!`)
                .addFields({ name: '⭐ Stellar XP', value: `+${xpGanho} XP`, inline: true });
        ...
        // ========== COMANDO: SAIR ==========
            ...
            const embed = new EmbedBuilder()
                .setColor(0xFFA500)
                .setTitle('🚪 Você saiu do clã!')
                .setDescription(`✅ Você saiu do clã **${clan.nome}**!`)
                .addFields({ name: '⭐ Stellar XP', value: `+${xpGanho} XP`, inline: true });
        ...
        // ========== COMANDO: TRANSFERIR ==========
            ...
            const embed = new EmbedBuilder()
                .setColor(0xFFD700)
                .setTitle('👑 Liderança Transferida!')
                .setDescription(`✅ Liderança do clã **${clan.nome}** transferida para ${user}!`)
                .addFields({ name: '⭐ Stellar XP', value: `+${xpGanho} XP`, inline: true });
        ...
        // ========== COMANDO: DELETAR ==========
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`✅ Clã **${clan.nome}** foi deletado!`)
                .addFields({ name: '⭐ Stellar XP', value: `+${xpGanho} XP`, inline: true });
        ...
        // ========== COMANDO: DOAR ==========
            ...
            const xpGanhoClan = Math.floor(quantia / 1000);
            db.clans[clanId].xp = (db.clans[clanId].xp || 0) + xpGanhoClan;
        ...
        // ========== COMANDO: SACAR (30% DOS RECURSOS - APENAS LÍDER) ==========
            ...
            if (!cooldownCheck.available) {
                return message.reply(`⏰ Você já sacou recursos esta semana orbital! Próximo saque disponível em **${cooldownCheck.formatted}**.`);
            }
            
            if (!clan.recursos || clan.recursos <= 0) {
                return message.reply('❌ O clã não tem recursos orbitais disponíveis para saque! Peça para os membros doarem.');
            }
            ...
            if (valorSaque <= 0) {
                return message.reply('❌ Valor mínimo de saque orbital é 1 Orb!');
            }
            ...
            const embed = new EmbedBuilder()
                .setColor(0xFFD700)
                .setTitle('💰 Saque de Recursos Orbitais!')
                .setDescription(`📦 **${message.author.username}** sacou recursos da **Star Federation**!`)
                .addFields(
                    { name: '📊 Percentual Sacado', value: `30% dos recursos orbitais`, inline: true },
                ...
                .setFooter({ text: '⏰ Próximo saque orbital disponível em 7 dias!' });
        ...
        // ========== COMANDO: RANKING ==========
            ...
            const embed = new EmbedBuilder()
                .setColor(0xFFD700)
                .setTitle('🏆 Ranking de Clãs Orbitais')
                .setDescription('Os clãs mais poderosos da galáxia!')
                .addFields({ name: '⭐ Stellar XP', value: `+${xpGanho} XP (consulta)`, inline: true });
            ...
            embed.setFooter({ text: '🚀 Star Federation • Suba no ranking orbital com seu clã!' });
            await message.reply({ embeds: [embed] });
        }
        ...
        // ========== COMANDO: AJUDA ==========
            ...
            const embed = new EmbedBuilder()
                .setColor(0xFFD700)
                .setTitle('🚀 Star Federation - Sistema de Clãs Orbitais')
                ...
                .addFields(
                    ...
                    { name: '💰 `bt!clan sacar`', value: 'Líder saca 30% dos recursos (1x por semana orbital)', inline: false },
                    { name: '🏆 `bt!clan ranking`', value: 'Ranking de clãs', inline: false },
                    { name: '⭐ Stellar XP', value: `+${xpGanho} XP (comando orbital)`, inline: true }
                )
                .setFooter({ text: '🚀 Star Federation • União entre exploradores orbitais!' });
