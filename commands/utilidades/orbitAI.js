...
const orbitPersonality = {
    ...
    frasesCooldown: ['⏰ Calma, comandante!', '🔄 Sistemas recarregando.', '🔋 Energia em recuperação.', '🌙 Tenha paciência.', '📡 Sinal instável.'],
    eventos: [
...
function getComandoFrase(comando) {
    const frases = { 'missao': '🎯 Iniciando Galactic Quest...', 'pirataria': '☄️ Preparando ataque...' };
